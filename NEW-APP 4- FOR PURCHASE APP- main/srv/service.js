...
//     // ------------------------------------------------
//     // Validation Before Save - Purchase Orders
//     // ------------------------------------------------
//     this.before(['CREATE', 'UPDATE'], PurchaseOrders, async (req) => {
...
//     // ------------------------------------------------
//     // Recalculate on Create/Update/Delete
//     // ------------------------------------------------
//     this.after(['CREATE', 'UPDATE'], POItems, async (data) => {
...
//     this.after('DELETE', POItems, async (data) => {
...
//             req.error('Rejected order cannot be submitted')
//         }
...
//         return `Rejected Successfully : ${reason}`
//     })
